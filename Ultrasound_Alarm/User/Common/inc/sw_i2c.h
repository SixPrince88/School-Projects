...
uint8_t SW_I2C_Write(sw_i2c_OO_t* i2c_group, uint8_t addr, const uint8_t* data, uint8_t data_length);

uint8_t SW_I2C_Reg_Read(sw_i2c_OO_t* i2c_group, uint8_t dev_addr, uint8_t reg_addr, uint8_t* data, uint8_t data_length);
uint8_t SW_I2C_Reg_Write(sw_i2c_OO_t* i2c_group, uint8_t dev_addr, uint8_t reg_addr, const uint8_t* data, uint8_t data_length);
