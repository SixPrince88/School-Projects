...
gpio_init_t signal_gpio[] = {
    {.gpio_x = GPIOC, .pin_x = PIN_13, .mode_x = MODE_OPP,.invert=true},
    {.gpio_x = GPIOB, .pin_x = PIN_9, .mode_x = MODE_OPP,.invert=true},
    {.gpio_x = GPIOB, .pin_x = PIN_8, .mode_x = MODE_OPP,.invert=true},
    {.gpio_x = GPIOA, .pin_x = PIN_11, .mode_x = MODE_OPP,.invert=true},
    {.gpio_x = GPIOA, .pin_x = PIN_8, .mode_x = MODE_OPP,.invert=true},
};
...
{
    My_GPIO_All_Init(signal_gpio, 6);
